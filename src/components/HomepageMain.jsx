    ...
    <main className='bg-gray-100 h-screen w-full'>
      ...
      <div className='h-full w-full flex items-center justify-center flex-col md:flex-row gap-3'>
        <section className='card'>
          <img src={People} alt='create a page' className='w-1/3 h-1/3 object-cover aspect-square'/>
          <h1 className='text-2xl text-indigo-500 font-bold'>create a page</h1>
          <button className='mt-5 bg-indigo-500 rounded text-white text-bold px-9 py-2'>create</button>
        </section>
        ...
        <section className='card h-full'>
          <img src={OpenImg} alt='open a page' className='w-1/3 h-1/3 object-cover aspect-square' />
